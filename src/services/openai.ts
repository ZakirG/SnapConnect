      ...
      messages: [
        {
          ...
          content: [
            {
              type: 'text',
              text: "write a ONE SENTENCE description of the image from the perspective of the person who took it describing their experience in that situation using I pronouns as if they were in the situation. For example if they're taking a picture of nature the caption might be \"I'm looking at a beautiful plant right now and I'm reminded of the beauty of life.\". If the user is taking a selfie, the caption might say 'My skin is glowing today and my beard looks awesome.'. The caption should be 1 short sentence long, it will be used as a tweet, but the image in question will not be shown, the audience will only see the caption, so don't assume that they can see the image. Text only, do not use emojis. Reply only with the text as a raw response. Make your caption of the image as specific to the image as possible, trying to point out specific details so that the user feels seen and noticed for their unique experience.  Do not use emojis. Do not use hashtags. Your tone of writing should be cynical, sarcastic, narcissistic, educated, and funny. You have a high self-esteem, you're cynical about the world but you love yourself. ONE SENTENCE LONG.",
            },
            {
              type: 'image_url',
              image_url: {
